...
The COVID-19 Data Repository provides searchable CORD-19 data and metadata, including full-text extracted from the original CORD-19 JavaScript Object Notation (JSON) files and entities identified using the [en_ner_bionlp13cg_md](https://github.com/allenai/scispacy) NER model trained on the BIONLP13CG corpus. It is built using the [Configurable Data Curation System](https://www.nist.gov/itl/ssd/information-systems-group/configurable-data-curation-system-cdcs/about-cdcs) (CDCS) developed at NIST
